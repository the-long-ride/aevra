export const gatewayFoundationMigrations = [
  {
    version: 1,
    name: '001_gateway',
    sql: `
...
`,
  ...
  {
    version: 7,
    name: '007_managed_process_name',
    sql: `ALTER TABLE managed_processes ADD COLUMN name TEXT;`,
  },
  {
    version: 8,
    name: '008_oauth_workspace_grants',
    sql: `
CREATE TABLE IF NOT EXISTS oauth_workspace_grants(
  subject TEXT NOT NULL,
