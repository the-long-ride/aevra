...
export const SAFE_COMMAND_MATCHERS: SafeCommandMatcher[] = [
  ...
  },
  {
    matcher: 'git:fetch',
    example: 'git fetch',
    purpose: 'Fetch remote refs without integrating them into the current branch',
    platforms: ['windows', 'linux', 'macos'],
    riskNote: 'Uses the network and updates remote-tracking refs plus FETCH_HEAD.',
  },
  {
    matcher: 'git:pull',
    example: 'git pull --ff-only',
    purpose: 'Fetch and integrate the current branch from its configured upstream',
    platforms: ['windows', 'linux', 'macos'],
    riskNote: 'Mutating operation: may update the branch and working tree and may run Git hooks.',
  },
  {
    matcher: 'npm:test',
    example: 'npm test',
    ...
    platforms: ['windows', 'linux', 'macos'],
    riskNote: 'May execute project-defined test scripts; review repository scripts first.',
  },
  {
    matcher: 'pnpm:test',
    example: 'pnpm test',
  ...
  },
  {
    ...
    platforms: ['windows', 'linux', 'macos'],
    riskNote: 'May contact configured package sources and run restore-related project logic.',
  },
  {
  ...
  },
  {
    ...
    platforms: ['linux', 'macos'],
    riskNote: 'Read-only directory inspection. The wildcard covers listing arguments.',
  },
];
