...
function setup(bindings: { workspaceId: string | null; profileCap: string | null }) {
  ...
  const sessions = new SessionManager(new SessionRepository(raw), profiles);
