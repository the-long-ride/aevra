...
export class OperationService {
  ...
  constructor(
    ...
    this.commandExecution = new CommandExecution(sessions, workspaces, worker, locks, (tokens) =>
  ...
  async patch(
    ...
    return patchFileMutation(
      ...
      (content, expectedHash) =>
        this.write(sessionId, { path: input.path, content, expectedHash }, authorization),
    );
  }
